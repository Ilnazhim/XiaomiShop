...
@allure.description("Test order_from_product_page")
def test_order_from_product_page_close_popap(browser):
...
@allure.description("Test pre-order_from_product_page")
def test_pre_order_from_product_page_close_popap(browser):
    ...
    pp = ProductPage(browser, link)
    pp.open()
    pp.make_the_pre_order_close_popap()
